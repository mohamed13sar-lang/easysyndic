...
const styles = StyleSheet.create({
  ...
  amountText: { marginTop: 12, color: '#1F2328', fontSize: 14, fontWeight: '800' },
  ...
  optionText: { color: '#1F2328', fontSize: 13, fontWeight: '700' },
  optionTextSelected: { color: '#FFFFFF' },
  formGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 8 },
  input: { minHeight: 50, minWidth: 140, flexGrow: 1, flexBasis: '45%', borderRadius: 14, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#F9FAFB', paddingHorizontal: 14, color: '#1F2328', fontSize: 14, fontWeight: '600' },
  ...
  secondaryButtonText: { color: '#1F2328', fontSize: 14, fontWeight: '800' },
  ...
  transactionAmount: { color: '#1F2328', fontSize: 14, fontWeight: '800' },
  ...
  proofTitle: { color: '#1F2328', fontSize: 13, fontWeight: '800' },
