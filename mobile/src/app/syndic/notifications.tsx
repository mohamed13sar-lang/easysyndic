...
const styles = StyleSheet.create({
  ...
  messageText: { marginTop: 8, color: '#111827', fontSize: 14, lineHeight: 20, fontWeight: '500' },
  ...
  detailMessage: { color: '#111827', fontSize: 15, lineHeight: 22, fontWeight: '600', marginBottom: 12 },
