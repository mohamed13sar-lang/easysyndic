...
const styles = StyleSheet.create({
  ...
  totalValue: { color: '#111827', fontSize: 24, fontWeight: '800' },
  ...
  description: { marginTop: 12, color: '#111827', fontSize: 14, lineHeight: 20, fontWeight: '500' },
  ...
  mediaText: { flex: 1, color: '#111827', fontSize: 13, fontWeight: '800' },
  sectionLabel: { marginTop: 14, marginBottom: 8, color: '#111827', fontSize: 13, fontWeight: '800' },
  ...
  commentInput: { flex: 1, color: '#111827', fontSize: 14, fontWeight: '600' },
